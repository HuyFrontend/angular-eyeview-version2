...
L.Marker.crosshair  =  function (options) {
  return new L.Marker.Crosshair(options);
};

L.Marker.Crosshair = L.Marker.extend({
  options: {
    crosshairHTML: '<img alt="Center of the map; crosshair location" title="Crosshair" src="../images/crosshair.png" width="100px" />'
  },
